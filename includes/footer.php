    ...
    <div class="container-fluid">
        <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0">
                <div class="copyright text-center text-sm text-muted text-lg-start position-fixed bottom-0 mb-4 ">
                    © <script>
...
<script src="<?= BASE_URL ?>/template/assets/js/material-dashboard.min.js?v=3.0.4"></script>
</body>
